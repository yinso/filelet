...
(function() {
  var async, copy, fs, functlet, glob, loadFile, loadFiles, loglet, mkdirP, mkdirp, move, ncp, newname, path, readBuffer, readdirRSync, rename, saveFiles, utilities, vinyl, writeArray, writeFile,
    __slice = [].slice;
